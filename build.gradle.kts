...
tasks.register("javaPreCommit") {
  ...
  dependsOn(":sdks:java:io:amazon-web-services2:build")
  dependsOn(":sdks:java:io:amazon-web-services:build")
  ...
  dependsOn(":sdks:java:io:google-cloud-platform:build")
  dependsOn(":sdks:java:io:google-cloud-platform:expansion-service:build")
  dependsOn(":sdks:java:io:hadoop-common:build")
  dependsOn(":sdks:java:io:hadoop-file-system:build")
  dependsOn(":sdks:java:io:hadoop-format:build")
  ...
  dependsOn(":sdks:java:io:kinesis:build")
  dependsOn(":sdks:java:io:kinesis:expansion-service:build")
  ...
  dependsOn(":sdks:java:io:snowflake:build")
  dependsOn(":sdks:java:io:snowflake:expansion-service:build")
